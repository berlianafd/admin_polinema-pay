...
$result = mysqli_query($koneksi, "SELECT * FROM konversiharga ORDER BY id");
            ...
            <div class="page-header float-left">
              <div class="page-title">
                <ol class="breadcrumb text-right">
                  ...
                  <li class="active">Konversi Harga</li>
                </ol>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header" align="center">
                <strong class="card-title">Konversi Harga</strong>
              </div>
                ...
                <table class="table table-hover ">
                  ...
                  <tbody>
                    ...
                    while($user_data = mysqli_fetch_array($result)) {
                      ...
                      echo "<td><a class='btn btn-success' href='konversiharga-edit.php?id=$user_data[id]'><i class='fa fa-pencil'></i> Edit</a>
                      </td>";
                      echo "</tr>";
                    }
                    ?>
