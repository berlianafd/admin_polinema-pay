                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li class="active"><i class="ti-server"></i><a href="riwayat-tukarpoin.php">Tukar Poin</a></li>
                        </ul>
                    </li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header" align="center">
                                <strong class="card-title">Riwayat Tukar Poin</strong>
                            </div>
                                ...
                                <table class="table ">
                                    ...
                                    <tbody>
                                      ...
                                      if(isset($_POST['qcari'])){
                                        ...
                                        $query = mysqli_query($koneksi,"SELECT r.idUser, u.name, r.poin, r.created_at FROM riwayat AS r INNER JOIN user AS u ON r.idUser = u.id WHERE r.fitur='tp'"); 
                                    }
