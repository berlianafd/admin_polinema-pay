                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li class="active"><i class="ti-trash"></i><a href="riwayat-tukarsampah.php">Tukar Sampah</a></li>
                ...
                <div class="row m-0">
                        ...
                        <div class="page-header float-left">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Tukar Sampah</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-8">
                        <div class="page-header float-right">
                            <form class="search-form" action="riwayat-tukarsampah.php" method="post">
                                <strong class="card-title"><input type="form-control mr-sm-2" placeholder="Nama.." aria-label="Search" name="qcari"></strong>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header" align="center">
                                <strong class="card-title">Riwayat Tukar Sampah</strong>
                            </div>
                                ...
                                <table class="table ">
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($_POST['qcari'])){
                                          $qcari=$_POST['qcari'];
                                          $result1 = mysqli_query($koneksi,"select count(*) from riwayat where name like '%$qcari%'");
                                      } else {
                                          $result1 = mysqli_query($koneksi, "SELECT count(*) FROM riwayat");
                                      }
                                      ...
                                      if(isset($_POST['qcari'])){
                                          $qcari=$_POST['qcari'];
                                          $query = mysqli_query($koneksi,"SELECT r.idUser, u.name, r.poin, r.created_at FROM riwayat AS r INNER JOIN user AS u ON r.idUser = u.id where name like '%$qcari%' limit $mulai, $batas");
                                      } else { 
                                        $query = mysqli_query($koneksi,"SELECT r.idUser, u.name, r.poin, r.created_at FROM riwayat AS r INNER JOIN user AS u ON r.idUser = u.id WHERE r.fitur='ts'"); 
                                    }
                                    while ($menu = mysqli_fetch_array($query)) {
                                      ...
                                      <tr >
                                        ...
                                        <td><p><?php echo $menu['created_at'];?></p></td>
                                    </tr>
                                    <?php
                                    $no++;
                                }
