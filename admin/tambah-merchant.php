                ...
                <div class="row m-0">
                        ...
                        <div class="page-header float-left">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Tambah Merchant</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="page-header float-right">
                            <form class="search-form" action="tambah-merchant.php" method="post">
                                        ...
                                        <?php
                                            ...
                                            while ($menu = mysqli_fetch_array($query)) {
                                              ...
                                              <tr>
                                                ...
                                                <input type="text" name="id" value="<?php echo $menu['id'];?>" readonly="">
                                                </td>
                                                <td><p><?php echo $menu['username'];?></p></td>
                                                <td><p><?php echo $menu['nohp'];?></p></td>
                                                <td><p><button type="submit" name="Submit" class="btn btn-info">Menjadi Merchant</button></p></td>
                                            </tr>
                                            </form>
                                            <?php
                                            $no++;
...
<script src="assets/js/main.js"></script>
    ...
    <?php
        ...
        // Update produk data into table
            $result = mysqli_query($koneksi, "UPDATE user SET `level`='Merchant' WHERE `id` = $id");
            ...
            if( mysqli_query($koneksi, $result)) {
              ...
              header("Location: user-merchant.php");
            }
          }
