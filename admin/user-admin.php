...
$query = mysqli_query($koneksi,"SELECT * FROM admin ORDER BY id_user");
                ...
                <div class="row m-0">
                    ...
                    <div class="col-sm-8">
                        <div class="page-header float-right">
                            <form class="search-form" action="user-admin.php" method="post">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            if(isset($_POST['qcari'])){
                                                $qcari=$_POST['qcari'];
                                                $result1 = mysqli_query($koneksi,"select count(*) from admin where username like '%$qcari%'");
                                            } else {
                                                $result1 = mysqli_query($koneksi, "SELECT count(*) FROM admin");
                                            }
                                            ...
                                            if(isset($_POST['qcari'])){
                                                $qcari=$_POST['qcari'];
                                                $query = mysqli_query($koneksi,"SELECT  id_user, username, name, password, notelp, foto FROM admin where username like '%$qcari%' limit $mulai, $batas");
                                            } else { 
                                            ...
                                            while ($menu = mysqli_fetch_array($query)) {
                                              ...
                                              <tr>
                                                ...
                                                <td style="display:none"><p><?php echo $menu['id_user']; ?></p></td>
                                                <td><p><?php echo $menu['username'];?></p></td>
                                                <td><p><?php echo $menu['name'];?></p></td>
                                                <td><p><?php echo $menu['notelp'];?></p></td>
                                                <td><p><a href="hapus-admin.php?id_user=<?php echo $menu['id_user']; ?>" class="btn btn-danger" ><i class='fa fa-trash'></i></a></p></td>
