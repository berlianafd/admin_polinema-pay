        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="user-mahasiswa.php" > <i class="menu-icon fa fa-users"></i>User</a></li>
                ...
                <div class="row m-0">
                    ...
                    <div class="col-sm-8">
                        <div class="page-header float-right">
                            <form class="search-form" action="user-mahasiswa.php" method="post">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            if(isset($_POST['qcari'])){
                                                ...
                                                $query = mysqli_query($koneksi,"SELECT * FROM user where level='User' order by name ASC");   
                                            }
